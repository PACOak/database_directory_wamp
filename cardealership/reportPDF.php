...
//$pdf->Cell(10,50,'',0,1,'L',0);
$pdf->SetFillColor(200,200,200);
$pdf->SetTextColor(75,75,75);
//printing data
$pdf->Cell(150,20,'Average Price:',0,0,'L',1);
$pdf->Cell(40,20,'$' . number_format($dataAVG,2),0,1,'R',1);
$pdf->Cell(150,20,'Min Price:',0,0,'L',1);
$pdf->Cell(40,20,'$' . number_format($dataMIN,2),0,1,'R',1);
$pdf->Cell(150,20,'Max Price:',0,0,'L',1);
$pdf->Cell(40,20,'$' . number_format($dataMAX,2),0,1,'R',1);
$pdf->Cell(150,20,'Total Cars:',0,0,'L',1);
$pdf->Cell(40,20,'$' . number_format($dataCOUNT,2),0,1,'R',1);
